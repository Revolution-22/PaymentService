...
public class BeanConfiguration {
    ...
    @Bean
    PaymentFacade paymentFacade(PaymentService paymentService, BrokerService brokerService, ProviderService providerService, BankService bankService) {
        return paymentBeanConfiguration.paymentFacade(paymentService, brokerService, providerService, bankService);
    }
